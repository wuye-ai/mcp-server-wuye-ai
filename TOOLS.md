...
|---------------------|-----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----|------|---------|--------|-----|
| `获取资讯日报`            | `GetNewsForDate`                              | 获取资讯日报：根据YYYY-MM-DD形式的日期，获取当日物业行业资讯日报。请注意，每天的资讯日报包含的新闻资讯，一般是前一天发布的，而不是当天。                                               | `date`(要获取资讯日报的日期，形如 YYYY-MM-DD。如果不提供，则默认为今天。建议使用两个月内的日期，更早的日期返回时间会较长。)                                                              | ✅   | ✅    | ✅       | ✅      | ❌   |
